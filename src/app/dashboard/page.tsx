    ...
    <main className="min-h-screen bg-black text-white selection:bg-white/30 selection:text-white pb-20">
          ...
          <FadeIn>
            <div className="flex items-center gap-6">
              ...
              <div className="hidden sm:flex items-center gap-4 border-l border-white/10 pl-4">
                <a href="/dashboard" className="text-xs font-mono uppercase tracking-wider text-white">Dashboard</a>
                <a href="/dashboard/vault" className="text-xs font-mono uppercase tracking-wider text-muted-foreground hover:text-white transition-colors">Private Vault</a>
              </div>
            </div>
          </FadeIn>
      ...
      <div className="max-w-6xl mx-auto px-6 mt-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <FadeIn delay={0.3} className="md:col-span-2 space-y-6">
            <div className="p-8 rounded-xl border border-white/10 bg-[#0a0a0a] shadow-2xl space-y-8">
               <PasskeyManager authenticators={authenticators} />
            </div>

            <div className="p-8 rounded-xl border border-white/10 bg-[#0a0a0a] shadow-2xl relative overflow-hidden group">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-medium">Private Master Vault</h3>
                  <p className="text-sm text-muted-foreground mt-1">Access highly sensitive personal files with biometric step-up authentication.</p>
                </div>
                <div className="pt-2">
                  <a href="/dashboard/vault" className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-white hover:text-muted-foreground transition-colors">
                    Access Vault &rarr;
                  </a>
                </div>
              </div>
